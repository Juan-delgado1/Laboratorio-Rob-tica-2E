...
class PincherController(Node):
    def __init__(self):
        ...
        self.current_joint_positions = [math.pi, 0.0, 0.0, 0.0, 0.0]   # Para 5 articulaciones / ejes
        ...
        # Offset adicional en radianes para cada articulación publicada a RViz
        self.joint_offset = {
            1: math.pi,   # 180° para corregir el giro del motor 1
            2: 0.0,
            3: 0.0,
            4: 0.0,
            5: 0.0,
    ...
    def initialize_motors(self, goal_positions, moving_speed, torque_limit):
        ...
        for dxl_id, goal in zip(self.dxl_ids, goal_positions):
            try:
                ...
                angle += self.joint_offset.get(dxl_id, 0.0)
    ...
    def radians_to_dxl(self, radians):
        ...
        return (radians * (center/half_range_rad)+center)
    ...
    def move_motor(self, motor_id, position):
        ...
        try:
            ...
            if result == 0:
                ...
                angle += self.joint_offset.get(motor_id, 0.0)
                self.current_joint_positions[joint_index] = angle

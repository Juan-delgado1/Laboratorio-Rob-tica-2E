...
## Introducción
Mediante este laboratorio se busca explorar el entorno de ROS 2 y consolidar conocimientos de este, enforcándose en el control básico de robots móviles y manipulación de mensaje. Así mismo se usan habilidades y conocimientos sobre python para programar trayectorias y comandos de los robots en un entorno simulado. Para esto, se lleva a cabo el control de una tortuga virtual que recibe comandos por teclado para su movimiento y sigue trauectorias definidas como lo son letras, con el fin de afianzar la forma en la que los comandos afectan el comportamiento de un robot. 
...
### 2. Implementar funciones para que la tortuga dibuje las iniciales de los miembros del equipo de trabajo al presionar la tecla correspondiente a cada letra:

◦ Tecla J: Dibuja la letra J. (Juan y Jose)    <br> 
◦ Tecla A: Dibuja la letra A. (Angel)   <br>
◦ Tecla V: Dibuja la letra V. (Vargas)  <br>
◦ Tecla R: Dibuja la letra R. (Rodriguez)<br>
◦ Tecla D: Dibuja la letra D. (Delgado) <br>
◦ Tecla E: Dibuja la letra E. (Estrada) <br>
◦ Tecla S: Dibuja la letra S. (Santiago) <br>
◦ Tecla M: Dibuja la letra M. (Mariño) <br>
◦ Tecla C: Dibuja la letra C. (Cortez) <br>
...
El vídeo de los resultados obtenidos se encuentra en el siguiente link: [Grupo 2e - Robótica de Desarrollo, Intro a ROS 2 Humble-Turtlesim - Laboratorio No. 4](https://youtu.be/iRpFHzRL37I)
